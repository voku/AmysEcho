...
- [ ] Surface modality coverage and training version in model headers so caregivers know they are using the multimodales DGS-Modell, ohne zusätzliche Sprach-Tags zu erzwingen.
