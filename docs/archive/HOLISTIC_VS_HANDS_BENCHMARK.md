...
Record results using the baseline template in `docs/testing/DGS_BASELINE_EVALUATION_TEMPLATE.md` and store raw measurements under `docs/testing/benchmarks/`.
