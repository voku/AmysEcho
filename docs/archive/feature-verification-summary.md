...
implementation has been removed from the repository; see `docs/architecture/migration/app-archive.md`
...
See `docs/training/video-recording-and-training-workflow.md` for the end-to-end flow and
QA checklist.
