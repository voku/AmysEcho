...
- For normalization formulas used in the client pipeline, see `docs/training/landmark-normalization.md`.
- For the planned recognition response payload, see `docs/training/recognition-response-format.md`.
