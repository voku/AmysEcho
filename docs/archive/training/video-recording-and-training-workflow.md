...
- `docs/testing/test-coverage-report-server.md`
...
Das Aufzeichnen, Bündeln, Hochladen, Trainieren und Aktualisieren der Modelle ist vollständig in der Webapp integriert. Prüfe den aktuellen Teststatus in den Test-Coverage-Berichten und führe die Test-Suites gemäß `docs/testing/testing-strategy.md` aus, bevor du Änderungen ausrollst.
