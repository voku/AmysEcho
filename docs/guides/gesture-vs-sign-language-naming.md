...
- **Cross-platform coupling**: The `webapp/src/gesture/` directory originated from the mobile webview. Renaming classes, folders, and message types would require careful coordination if a mobile client is reintroduced.
