...
| `GET /api/v1/dgs/dataset-readiness` | Required | none | dataset readiness summary with manifest counts, holdout status, shot readiness, blockers, and warnings | `404` when evaluator is unavailable, `500` when the summary cannot be generated |
