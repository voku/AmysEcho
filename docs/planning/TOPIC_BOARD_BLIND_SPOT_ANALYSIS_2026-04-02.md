...
- **Single source of truth for completed items archive:** `docs/planning/TODO_DONE.md`
...
- New board creation should start from `docs/planning/topics/_template/TOPIC_TEMPLATE.md`.
- `TODO.md` remains the planning index and status ledger.

- Completed tasks should be moved by cut/paste from `TODO.md` to `TODO_DONE.md` to keep one active board.
...
4. **Operational drift risk**
   - If the script is not re-run, `TODO_DONE.md` can diverge from git reality.
