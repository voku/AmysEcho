...
- [ ] **JUN-P1-6:** Define and implement a cron-backed post-training operations cadence (reconciliation, retention, summaries) without delaying upload-triggered training.
  ...
  - Entry points: `server/src/server.ts`, `server/src/routes/trainingJobsRoutes.ts`, `docs/operations/production-health-monitoring-ownership.md`, `docs/deployment/quickstart-server.md`
