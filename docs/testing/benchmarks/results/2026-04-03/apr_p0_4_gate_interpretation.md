...
G1–G4 mapping from `docs/testing/benchmarks/device_performance_protocol.md`.

## First command (handoff continuity)
`rg -n "APR-P0-4|G1|GO|NO-GO" docs/testing/benchmarks docs/planning`

## Input evidence used
- `docs/testing/benchmarks/performance_report_2026-03-27.md` (CI VM baseline)
- `docs/testing/benchmarks/device_performance_protocol.md` (§7 thresholds, §8 gate mapping)
