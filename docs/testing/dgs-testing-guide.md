...
- Follow the checklist in `docs/training/video-recording-and-training-workflow.md` to
  verify capture → upload → training → download end-to-end.
- Verify caregiver workflows per `docs/testing/real-world-validation-guide.md` whenever
  a new model ships.
