...
- Quarterly accessibility execution and ownership are defined in `docs/security/governance-cadence.md`.
- The latest completed manual cycle artifact is `docs/testing/accessibility-cycle-2026-q2.md`.
