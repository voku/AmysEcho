...
vi.mock('./AboutAmysEcho', () => ({ AboutAmysEcho: () => <div>About Mock</div> }));
vi.mock('./Admin', () => ({ Admin: () => <div>Admin Mock</div> }));
vi.mock('./CaregiverArea', () => ({ CaregiverArea: () => <div>CaregiverArea Mock</div> }));
vi.mock('./CaregiverReport', () => ({ CaregiverReport: () => <div>CaregiverReport Mock</div> }));
vi.mock('./CommunicationInsights', () => ({ CommunicationInsights: () => <div>CommunicationInsights Mock</div> }));
vi.mock('./Dashboard', () => ({ Dashboard: () => <div>Dashboard Mock</div> }));
vi.mock('./FeatureAvailability', () => ({ FeatureAvailability: () => <div>FeatureAvailability Mock</div> }));
...
vi.mock('./ProgressChart', () => ({ ProgressChart: () => <div>ProgressChart Mock</div> }));
vi.mock('./ProgressTracker', () => ({ ProgressTracker: () => <div>ProgressTracker Mock</div> }));
vi.mock('./Settings', () => ({ Settings: () => <div>Settings Mock</div> }));
vi.mock('./SettingsOverview', () => ({ SettingsOverview: () => <div>SettingsOverview Mock</div> }));
vi.mock('./SignLanguageHistory', () => ({ SignLanguageHistory: () => <div>SignLanguageHistory Mock</div> }));
vi.mock('./SignLanguageTutorial', () => ({ SignLanguageTutorial: () => <div>SignLanguageTutorial Mock</div> }));
vi.mock('./SignVideoGallery', () => ({ SignVideoGallery: () => <div>SignVideoGallery Mock</div> }));
